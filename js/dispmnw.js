// FICHIER : js/dispmnw.js
console.log("// FICHIER : js/dispmnw.js");
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const jsonPath = `/data/manwha/${code}.jsn`;
  ...
  fetch(jsonPath)
    ...
    .catch(err => {
      ...
      document.getElementById("fiche").innerHTML = "<p>Erreur chargement fiche manwha.</p>";
    });
});
...
function afficherLecteur(episode) {
  ...
  if (!episode.lien) {
    lecteur.innerHTML = `<p>Vidéo non disponible pour cet épisode.</p>`;
    return;
  }
